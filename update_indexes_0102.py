...
def update_indexes_0102():
    pdf_title = "Professional Software Developers Don't Vibe, They Control"
    ...
    if index_path.exists():
        ...
        new_item = f"""
        <li>
            <a href="day_slides/day_slide_2026_01_02.html" class="slide-link">
    ...
    if public_index_path.exists():
        ...
        new_item_public = f"""
            <div class="slide-card">
                <div class="slide-date">2026年1月2日</div>
                <div class="slide-title">{pdf_title}</div>

                <div class="slide-actions">
                    <a href="https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_2026_01_02.html" class="btn btn-primary">
                        🎯 スライドを開く
                    </a>
                    <a href="#" onclick="copyLink('https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_2026_01_02.html')"
