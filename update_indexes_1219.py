...
def update_indexes_1219():
    index_path = "presentations/day_slides_index.html"
    with open(index_path, "r", encoding="utf-8") as f:
        content = f.read()

    # New entry for 12/19
    new_entry = '<li><a href="day_slides/day_slide_2025_12_19.html" aria-describedby="slide-2025-12-19"><span class="date">2025/12/19</span><span class="slide-title">GPT-5.2-Codex: OpenAI、自律型エンジニアリングモデルをリリース</span></a></li>'
