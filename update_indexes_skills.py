...
def update_indexes_skills():
    today_str = "skills"
    date_slash = "Skill"
    title = "デイリーAIニューススライド生成スキル：標準ワークフロー"
    ...
    if index_path.exists():
        ...
        new_li = f'        <li><a href="day_slides/day_slide_{today_str}.html" aria-describedby="slide-{today_str}"><span class="date">{date_slash}</span><span class="slide-title">{title}</span></a></li>'
        
        if f'day_slide_{today_str}.html' not in content:
    ...
    if list_path.exists():
        ...
        new_card = f'''
      <a href="https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_{today_str}.html" class="slide-card">
