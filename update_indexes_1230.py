    ...
    if public_index_path.exists():
        ...
        new_item_public = f"""
            <div class="slide-card">
                <div class="slide-date">2025年12月30日</div>
                <div class="slide-title">{pdf_title}</div>

                <div class="slide-actions">
                    <a href="https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_2025_12_30.html" class="btn btn-primary">
                        🎯 スライドを開く
                    </a>
                    <a href="#" onclick="copyLink('https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_2025_12_30.html')"
