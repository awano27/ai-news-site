...
new_slides_content = """        <div class="slides">
            ...
            <section>
                ...
                <div class="key-points">
                    ...
                    <div class="key-point">
                        <h4>🌍 地政学的インパクト</h4>
                        <p>中国発のオープンソース戦略がアメリカ企業中心 of AIリーダーシップに挑戦。グローバルなイノベーション加速と新たな技術競争の幕開け。</p>
                    </div>
                </div>
            </section>
...
# I will find the part BEFORE <div class="reveal"> and AFTER its closing tag.
# Standard reveal structure:
# <div class="reveal">
#   <div class="slides">
#     ...
#   </div>
...
prefix_end_tag = '<div class="reveal">'
suffix_start_tag = '    <script>'

prefix_idx = orig_content.find(prefix_end_tag) + len(prefix_end_tag)
suffix_idx = orig_content.find(suffix_start_tag)

if prefix_idx > len(prefix_end_tag) and suffix_idx > 0:
    prefix = orig_content[:prefix_idx]
    suffix = orig_content[suffix_idx:]
    
    final_content = prefix + "\n" + new_slides_content + "\n    </div>\n\n" + suffix
    
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(final_content)
    print("Successfully rebuilt the entire file.")
else:
    print(f"Indices not found: prefix={prefix_idx}, suffix={suffix_idx}")
