#!/usr/bin/env python3
"""Render 0106.pptx slides to images using Aspose.Slides"""
import sys
...
def main():
    pptx_file = Path("D:/ai-news-site-main/input/day/0106.pptx")
    ...
    slide_count = render_pptx_slides(pptx_file, output_dir)
    if slide_count > 0:
        print(f"\n✅ Successfully converted {slide_count} slides")
        return 0
    else:
        return 1
