#!/usr/bin/env python3
"""Convert v2 HTML slides to images"""
import os
import sys
...
def main():
    ...
    slides = [
        workspace / "slide1_v2.html",
        workspace / "slide2_v2.html",
        workspace / "slide3_v2.html",
        workspace / "slide4_v2.html",
        workspace / "slide5_v2.html"
    ]
    ...
    print(f"\nAll v2 slides converted to {output_dir}")
