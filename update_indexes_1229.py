...
def update_indexes_1229():
    ...
    if index_path.exists():
        ...
        <li>
            <a href="day_slides/day_slide_2025_12_29.html" class="slide-link">
                ...
                <span class="title">Defining The AI World: Structural Hallucination Prevention</span>
            </a>
        </li>"""
    ...
    if public_index_path.exists():
        ...
        new_item_public = """
        <li>
            <a href="https://awano27.github.io/ai-news-site/presentations/day_slides/day_slide_2025_12_29.html" class="slide-link">
                <span class="date">2025.12.29</span>
                <span class="title">Defining The AI World: Structural Hallucination Prevention</span>
            </a>
        </li>"""
